...
# Cleans the data
cleaning_outputs = data/processed/clean_data.csv \
...
data_inputs = data/processed/cleaned_data.csv \
	data/processed/X_train.csv \
	data/processed/y_train.csv

$(split_outputs) $(eda_outputs): $(data_inputs)
...
evaluation_outputs = confusion_matrix_class_3.png \
	confusion_matrix_class_4.png \
	confusion_matrix_class_5.png \
	confusion_matrix_class_6.png \
	confusion_matrix_class_7.png \
	confusion_matrix_class_8.png \
...
evaluation_inputs = data/processed/X_test.csv \
 ...
 $(evaluation_outputs): 
	python scripts/model_evaluation.py \
		...
		--test_split_path=data/processed/ --test_accuracy_path=results/tables/ \
		--figures_path=results/figures/
...
$(report_outputs): report/wine_predictor_analysis_report.qmd report/references.bib
