...
def test_save_confusion_matrix_multi_outputs_correct():
    ...
    assert os.path.exists('temp/confusion_matrix_class_class_0.png')
    assert os.path.exists('temp/confusion_matrix_class_class_1.png')
    assert os.path.exists('temp/confusion_matrix_class_class_2.png')
